...
def main():
    ...
    logger.info("Instantiating SparseDistillationTrainer.")
    trainer = ed.SparseDistillationTrainer(
    ...
    logger.info("Starting sparse distillation fine-tune.")
    trainer.train()
    logger.info("Sparse distillation run finished.")
