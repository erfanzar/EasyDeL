...
class TestQwen3VLMoE:
    ...
    def test_vision_language(self, qwen3_vl_moe_config, small_model_config, vlm_config, hf_qwen3_vl_moe_class):
    ...
    def test_text_only(self, qwen3_vl_moe_config, small_model_config, hf_qwen3_vl_moe_class):
