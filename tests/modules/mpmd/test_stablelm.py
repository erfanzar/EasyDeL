...
class TestStableLM:
    ...
    def test_causal_lm(self, stablelm_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, stablelm_config, small_model_config, mpmd_schedule_kind):
