...
class TestMamba2:
    ...
    def test_causal_lm(self, mamba2_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, mamba2_config, small_model_config, mpmd_schedule_kind):
