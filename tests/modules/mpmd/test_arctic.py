...
class TestArctic:
    ...
    def test_causal_lm(self, arctic_config, hf_arctic_class, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, arctic_config, hf_arctic_class, small_model_config, mpmd_schedule_kind):
