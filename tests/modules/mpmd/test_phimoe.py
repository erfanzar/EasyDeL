...
class TestPhiMoE:
    ...
    def test_causal_lm(self, phimoe_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, phimoe_config, small_model_config, mpmd_schedule_kind):
