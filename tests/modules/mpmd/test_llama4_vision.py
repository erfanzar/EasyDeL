...
class TestLlama4Vision:
    ...
    def test_vision_language(self, llama4_vision_config, small_model_config, vlm_config, mpmd_schedule_kind):
    ...
    def test_generation(self, llama4_vision_config, small_model_config, mpmd_schedule_kind):
