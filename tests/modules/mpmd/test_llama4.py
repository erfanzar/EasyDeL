...
class TestLlama4:
    ...
    def test_causal_lm(self, llama4_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, llama4_config, small_model_config, mpmd_schedule_kind):
