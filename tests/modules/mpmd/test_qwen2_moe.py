...
class TestQwen2Moe:
    ...
    def test_causal_lm(self, qwen2_moe_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, qwen2_moe_config, small_model_config, mpmd_schedule_kind):
