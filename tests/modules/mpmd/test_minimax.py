...
class TestMiniMaxTextV1:
    ...
    def test_causal_lm(self, minimax_text_v1_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, minimax_text_v1_config, small_model_config, mpmd_schedule_kind):
