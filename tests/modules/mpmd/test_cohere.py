...
class TestCohere:
    ...
    def test_causal_lm(self, cohere_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, cohere_config, small_model_config, mpmd_schedule_kind):
