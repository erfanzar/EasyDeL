...
class TestGLMMoeDSA:
    ...
    def test_causal_lm(self, glm_moe_dsa_config, small_model_config, hf_glm_moe_dsa_class, mpmd_schedule_kind):
    ...
    def test_generation(self, glm_moe_dsa_config, small_model_config, hf_glm_moe_dsa_class, mpmd_schedule_kind):
