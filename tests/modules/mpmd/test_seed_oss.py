...
class TestSeedOSS:
    ...
    def test_causal_lm(self, seed_oss_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, seed_oss_config, small_model_config, mpmd_schedule_kind):
