...
class TestMixtral:
    ...
    def test_causal_lm(self, mixtral_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, mixtral_config, small_model_config, mpmd_schedule_kind):
