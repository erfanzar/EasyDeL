...
class TestEXAONE:
    ...
    def test_causal_lm(self, exaone_config, hf_exaone_class, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, exaone_config, hf_exaone_class, small_model_config, mpmd_schedule_kind):
