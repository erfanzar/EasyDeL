...
class TestSmolLM3:
    ...
    def test_causal_lm(self, smollm3_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, smollm3_config, small_model_config, mpmd_schedule_kind):
