...
class TestGlm4vMoe:
    ...
    @pytest.mark.parametrize("mpmd_schedule_kind", LOSS_SCHEDULE_KINDS, indirect=True)
    def test_text_only(self, glm4v_moe_config, small_model_config, hf_glm4v_moe_class, mpmd_schedule_kind):
    ...
    def test_generation(self, glm4v_moe_config, small_model_config, hf_glm4v_moe_class, mpmd_schedule_kind):
