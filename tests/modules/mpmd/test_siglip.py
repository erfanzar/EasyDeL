...
class TestSigLIP:
    ...
    def test_vision_model(self, siglip_vision_config, small_model_config, mpmd_schedule_kind):
    ...
    @pytest.mark.parametrize("mpmd_schedule_kind", LOSS_SCHEDULE_KINDS, indirect=True)
    def test_text_model(self, siglip_text_config, small_model_config, mpmd_schedule_kind):
