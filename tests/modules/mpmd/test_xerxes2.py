...
class TestXerxes2:
    ...
    def test_causal_lm(self, xerxes2_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, xerxes2_config, small_model_config, mpmd_schedule_kind):
