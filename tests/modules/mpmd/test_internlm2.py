...
class TestInternLM2:
    ...
    def test_causal_lm(self, internlm2_config, small_model_config, hf_internlm2_class, mpmd_schedule_kind):
    ...
    def test_generation(self, internlm2_config, small_model_config, hf_internlm2_class, mpmd_schedule_kind):
