...
class TestQwen3_5:
    ...
    def test_causal_lm(self, qwen3_5_text_config, small_model_config, hf_qwen3_5_causal_class, mpmd_schedule_kind):
    ...
    def test_generation(self, qwen3_5_text_config, small_model_config, hf_qwen3_5_causal_class, mpmd_schedule_kind):
