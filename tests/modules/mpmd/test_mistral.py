...
class TestMistral:
    ...
    def test_causal_lm(self, mistral_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, mistral_config, small_model_config, mpmd_schedule_kind):
