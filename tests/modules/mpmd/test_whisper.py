...
class TestWhisper:
    ...
    def test_seq2seq(self, whisper_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, whisper_config, small_model_config, mpmd_schedule_kind):
