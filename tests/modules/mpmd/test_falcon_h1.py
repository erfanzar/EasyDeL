...
class TestFalconH1:
    ...
    def test_causal_lm(self, falcon_h1_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, falcon_h1_config, small_model_config, mpmd_schedule_kind):
