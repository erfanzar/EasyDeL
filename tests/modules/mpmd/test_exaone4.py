...
class TestEXAONE4:
    ...
    def test_causal_lm(self, exaone4_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, exaone4_config, small_model_config, mpmd_schedule_kind):
