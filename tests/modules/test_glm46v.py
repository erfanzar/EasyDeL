...
class TestGlm46V:
    ...
    def test_vision_language(self, glm46v_config, small_model_config, vlm_config, hf_glm46v_class):
    ...
    def test_text_only(self, glm46v_config, small_model_config, hf_glm46v_class):
    ...
    def test_generation(self, glm46v_config, small_model_config, hf_glm46v_class):
