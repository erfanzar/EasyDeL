...
- Core `Module` / `Variable` sharding metadata: load
  `.agents/skills/spectrax-core/SKILL.md`.
- eFormer mesh / sharding equivalent: load
  `.agents/skills/debug-eformer-escale/SKILL.md`.
- MPMD pipeline runtime: load `.agents/skills/spectrax-pipeline-runtime/SKILL.md`.
