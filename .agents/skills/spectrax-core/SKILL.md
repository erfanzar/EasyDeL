...
- Layer / model development: load `.agents/skills/spectrax-nn/SKILL.md`.
- Module-aware transforms: load `.agents/skills/spectrax-transforms/SKILL.md`.
- Pipeline runtime / MPMD stage issues: load
  `.agents/skills/spectrax-pipeline-runtime/SKILL.md`.
- Sharding / mesh issues: load `.agents/skills/spectrax-sharding/SKILL.md`.
