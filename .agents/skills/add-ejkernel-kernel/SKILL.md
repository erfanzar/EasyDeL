...
kernel, prefer `.agents/skills/optimize-ejkernel-kernel/SKILL.md`.
...
`.agents/skills/port-ejkernel-to-easydel-operation/SKILL.md` after this skill.
This skill is not enough by itself for cross-package porting.

## How To Apply This Skill

1. Load `.agents/skills/run-research/SKILL.md`.
...
- If a profile or dump requires the TPU and libtpu is busy, stop and route
  through `.agents/ops/OPS.md`; do not substitute CPU timing for TPU claims.
...
performance. Route through `.agents/ops/OPS.md`.
