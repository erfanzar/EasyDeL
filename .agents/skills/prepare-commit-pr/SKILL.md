...
`.agents/skills/review-pr/SKILL.md`; for releases, load
`.agents/skills/release-workspace/SKILL.md`.
...
- Do not create or restore `AGENTS.md` files for this repo unless the user
  reverses the current instruction.

## Checks

Run focused tests selected through `.agents/skills/test-workspace/SKILL.md` for
...
`.agents/skills/release-workspace/SKILL.md` for the full release flow.
