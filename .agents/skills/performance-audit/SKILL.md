...
This is a specialization of `.agents/skills/run-research/SKILL.md`. For
kernel-level optimization use `.agents/skills/optimize-ejkernel-kernel/SKILL.md`
...
- `.agents/ops/OPS.md` when serving throughput is in scope
