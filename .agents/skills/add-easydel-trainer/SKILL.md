...
- Compile-time HBM OOM or remat issues: load
  `.agents/skills/debug-training-oom/SKILL.md`.
- eLarge YAML wiring: load `.agents/skills/train-elarge/SKILL.md`.
- Checkpoint save/load or sharding layout: load
  `.agents/skills/eformer-checkpoint-sharding/SKILL.md`.
- Quantized model training: load `.agents/skills/quantization-layout/SKILL.md`.
