...
- Model or conversion trouble: load `.agents/skills/add-easydel-model/SKILL.md`
  or `.agents/skills/convert-checkpoint/SKILL.md`.
...
- Compile-time HBM OOM: load `.agents/skills/debug-training-oom/SKILL.md`.
- Serve mode or OpenAI-compatible output trouble: load
  `.agents/skills/debug-esurge/SKILL.md` and, for tool/reasoning outputs,
  `.agents/skills/tool-reasoning-parser/SKILL.md`.
