...
public:
  ...
  void operator()(Params const &params, char *smem_buf) {
    ...
    for (auto work_tile_info =
      ...
      flash::Softmax<2 * (2 * kBlockM / NumThreads),
      ...
      if constexpr (AppendKV) {
        bool tile_new_valid =
            mainloop.store_kv_new(params.mainloop, threadIdx.x, shared_storage,
      ...
      bool tile_valid =
          mainloop.mma(params.mainloop, tOrO, softmax, threadIdx.x, seqlen_info,
      ...
      if (tile_valid) {
        ...
        epilogue.store(params.epilogue, tOrO, softmax.row_sum, shared_storage,
                       tiled_mma, threadIdx.x, block_coord);
      } else {
