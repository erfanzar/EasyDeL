    ...
    *,
    ...
    if mask_function is not None:
        if k_in_lanes:
            ...
            assert rem == 0
            q_sequence = jnp.tile(q_sequence_ref[...], (1, repeats))
        else:
    ...
    if q_segment_ids_ref is not None:
        if k_in_lanes:
            ...
            q_ids = jnp.tile(q_segment_ids_ref[:], (1, repeats))
        else:
            ...
            kv_ids = jnp.tile(kv_segment_ids_ref[k_slice, :], (1, repeats))
...
def flash_attention_kernel(
    ...
    *,
    ...
    def body(kv_compute_index, _):
        ...
        alpha_o = jnp.tile(alpha, (1, head_dim_v_repeats))[..., : o_scratch_ref.shape[-1]]
    ...
    def end():
        l = l_scratch_ref[...]
        l_inv = jnp.tile(1.0 / l, (1, head_dim_v_repeats))[..., : o_scratch_ref.shape[-1]]
