...
class TestLLaVA:
    ...
    def test_vision_language(self, llava_config, small_model_config, vlm_config, mpmd_schedule_kind):
    ...
    @pytest.mark.parametrize("mpmd_schedule_kind", LOSS_SCHEDULE_KINDS, indirect=True)
    def test_text_only(self, llava_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, llava_config, small_model_config, mpmd_schedule_kind):
