...
class TestGemma3:
    ...
    def test_vision_language(self, gemma3_config, small_model_config, vlm_config, mpmd_schedule_kind):
    ...
    def test_generation(self, gemma3_config, small_model_config, mpmd_schedule_kind):
