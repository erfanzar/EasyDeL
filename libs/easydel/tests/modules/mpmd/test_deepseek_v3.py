...
class TestDeepSeekV3:
    ...
    def test_causal_lm(self, deepseek_v3_config, small_model_config, hf_deepseek_v3_class, mpmd_schedule_kind):
    ...
    def test_generation(self, deepseek_v3_config, small_model_config, hf_deepseek_v3_class, mpmd_schedule_kind):
