...
class TestCohere2:
    ...
    def test_causal_lm(self, cohere2_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, cohere2_config, small_model_config, mpmd_schedule_kind):
