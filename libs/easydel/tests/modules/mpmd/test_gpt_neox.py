...
class TestGPTNeoX:
    ...
    def test_causal_lm(self, gpt_neox_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, gpt_neox_config, small_model_config, mpmd_schedule_kind):
