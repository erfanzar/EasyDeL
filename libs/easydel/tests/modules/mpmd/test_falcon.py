...
class TestFalcon:
    ...
    def test_causal_lm(self, falcon_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, falcon_config, small_model_config, mpmd_schedule_kind):
