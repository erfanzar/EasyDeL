...
class TestDeepSeekV2:
    ...
    def test_causal_lm(self, deepseek_v2_config, small_model_config, hf_deepseek_v2_class, mpmd_schedule_kind):
    ...
    def test_generation(self, deepseek_v2_config, small_model_config, hf_deepseek_v2_class, mpmd_schedule_kind):
