...
class TestOpenELM:
    ...
    def test_causal_lm(self, openelm_config, small_model_config, hf_openelm_class, mpmd_schedule_kind):
    ...
    def test_generation(self, openelm_config, small_model_config, hf_openelm_class, mpmd_schedule_kind):
