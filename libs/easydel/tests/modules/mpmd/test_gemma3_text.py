...
class TestGemma3Text:
    ...
    def test_causal_lm(self, gemma3_text_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, gemma3_text_config, small_model_config, mpmd_schedule_kind):
