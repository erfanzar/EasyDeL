...
class TestGLM4MoeLite:
    ...
    def test_causal_lm(self, glm4_moe_lite_config, small_model_config, mpmd_schedule_kind):
    ...
    def test_generation(self, glm4_moe_lite_config, small_model_config, mpmd_schedule_kind):
