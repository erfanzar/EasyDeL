...
def make_tiny_model() -> Qwen3_5ForCausalLM:
    cfg = Qwen3_5TextConfig(
        vocab_size=_VOCAB, hidden_size=_HIDDEN, intermediate_size=256, num_hidden_layers=4,
        num_attention_heads=4, num_key_value_heads=2, head_dim=32, max_position_embeddings=512,
        layer_types=["linear_attention", "linear_attention", "linear_attention", "full_attention"],
        mtp_num_hidden_layers=1, mtp_loss_coef=0.0, attn_output_gate=True, rms_norm_eps=1e-6,
