...
| `EASYDEL_DISABLE_DRAFT_IN_VERIFY`   | `0`             | A/B escape hatch: force the two-dispatch verify->draft flow instead of the fused draft-in-verify program. | Benchmark fused vs two-dispatch spec decode.      |
