...
class Exaone4Model(EasyDeLBaseModule):
    ...
    def forward(
        ...
        def _layer_loop(block, carry):
            ...
            all_attentions, idx)`` through one EXAONE 4 decoder layer
            (post-norm with conditional RoPE / NoPE), optionally collecting
            per-layer hidden states or attention weights and threading the
            layer's KV cache view through the carry.
            """
