...
class FlaxChatGLMAttention(BaseAttentionModule):
    ...
    def __call__(
        ...
        sequences in the batch, `sequence_length` is the length
          freqs_cis (Tuple[chex.Array, chex.Array]): The `freqs_cis` parameter is a tuple
...
class FlaxChatGLMBlock(nn.Module):
    ...
    def __call__(
        ...
        layernorm_input = self.hidden_dropout(
...
class FlaxChatGLMPreTrainedModel(EasyDeLFlaxPretrainedModel):
