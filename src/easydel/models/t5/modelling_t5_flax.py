...
from easydel.models.t5.t5_configuration import T5Config as T5Config
...
class FlaxT5Attention(BaseAttentionModule):
    config: T5Config
    ...
    def __call__(
        ...
        if self.causal and (self.has_variable("cache", "cached_key") or init_cache):
            key_states, value_states, attention_attention_mask = (
...
class FlaxT5LayerSelfAttention(BaseAttentionModule):
    config: T5Config
    has_relative_attention_bias: bool = False
    dtype: jnp.dtype = jnp.bfloat16  # the dtype of the computation
...
class FlaxT5LayerCrossAttention(BaseAttentionModule):
    config: T5Config
    dtype: jnp.dtype = jnp.bfloat16  # the dtype of the computation
...
class FlaxT5PreTrainedModel(BaseNNXModule):
