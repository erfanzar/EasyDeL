...
from easydel.models.flax_modelling_utils import precompute_freqs_cis
from easydel.models.mistral.modelling_mistral_flax import (
    FlaxMistralDecoratorCollection,
)
from easydel.models.mistral.vision_mistral_configuration import VisionMistralConfig
from easydel.models.modelling_utils import BaseNNXModule


class FlaxVisionMistralPreTrainedModel(BaseNNXModule):
