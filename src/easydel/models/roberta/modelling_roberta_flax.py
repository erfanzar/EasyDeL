...
from easydel.models.roberta.roberta_configuration import RobertaConfig as RobertaConfig
...
class FlaxRobertaSelfAttention(BaseAttentionModule):
    config: RobertaConfig
    causal: bool = False
    ...
    def __call__(
        ...
        if layer_head_mask is None:
            out = self.attention_module.__call__(
...
class FlaxRobertaPreTrainedModel(BaseNNXModule):
