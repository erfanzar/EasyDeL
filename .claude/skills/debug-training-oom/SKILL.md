...
symptoms, read `.claude/ops/OPS.md`.
...
If the run is driven by eLarge, also load `.claude/skills/train-elarge/SKILL.md`.
...
- Optimizer temps: inspect optimizer state shape and sharding, then load
  `.claude/skills/eformer-checkpoint-sharding/SKILL.md` if serialization or
