...
- Layer / model development: load `.claude/skills/spectrax-nn/SKILL.md`.
- Module-aware transforms: load `.claude/skills/spectrax-transforms/SKILL.md`.
- Pipeline runtime / MPMD stage issues: load
  `.claude/skills/spectrax-pipeline-runtime/SKILL.md`.
- Sharding / mesh issues: load `.claude/skills/spectrax-sharding/SKILL.md`.
