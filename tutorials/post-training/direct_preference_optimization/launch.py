...
def main():
    ...
    arguments = ed.DPOConfig(  # pyright: ignore[reportPrivateLocalImportUsage]
        ...
        loss_config=ed.LossConfig(z_loss=0.0),  # pyright: ignore[reportPrivateLocalImportUsage]  # Z-loss regularization term in DPO loss (0.0 means off).
    ...
    trainer = ed.DPOTrainer(  # pyright: ignore[reportPrivateLocalImportUsage]
