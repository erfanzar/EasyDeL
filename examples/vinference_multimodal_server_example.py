...
def main():
	parser = argparse.ArgumentParser(
		description="Run the EasyDeL vInference API server for multimodal models"
	)
	...
	parser.add_argument(
		"--prefill_length", type=int, default=2048, help="Prefill sequence length"
	)

	parser.add_argument(
		"--max_new_tokens", type=int, default=1024, help="Maximum new tokens to generate"
	)

	parser.add_argument(
		"--vision_height", type=int, default=336, help="Image height for vision processing"
	)

	parser.add_argument(
		"--vision_width", type=int, default=336, help="Image width for vision processing"
	)
	...
	sharding_axis_dims = (1, 1, -1, 1)  # You may adjust this based on your hardware
