...
def parse_args():
	parser = argparse.ArgumentParser(
		description="Train a model using EasyDeL for Direct Preference Optimization (DPO)."
	)
	...
	parser.add_argument(
		"--learning_rate", type=float, default=1e-6, help="Learning rate for the optimizer."
	)
	parser.add_argument(
		"--warmup_steps",
		type=int,
	...
	# Logging and saving
	parser.add_argument(
		"--log_steps", type=int, default=5, help="Number of steps between logging metrics."
	)
	parser.add_argument(
		"--save_steps",
		type=int,
	...
	parser.add_argument(
		...
		action="store_true",
		help="Shuffle the training dataset before training.",
	)
