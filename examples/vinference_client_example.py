...
def text_completion(
	...
	if not stream:
		...
		result = {
			"choices": [
				{"message": {"role": "assistant", "content": "".join(collected_messages)}}
			],
...
def main():
	...
	mm_parser = subparsers.add_parser(
		"multimodal", help="Multimodal (text+image) completion"
	)
	...
	token_parser.add_argument(
		"--text", type=str, required=True, help="Text to count tokens for"
	)
