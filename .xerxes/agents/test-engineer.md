...
`.xerxes/skills/test-workspace/SKILL.md` (env trio, package targets, quality bar). This file adds authoring patterns.
...
Never claim training or serving readiness from constructor-only tests, and never present a CPU pass as
TPU/kernel/performance validation.
