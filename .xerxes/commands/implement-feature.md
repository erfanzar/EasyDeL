...
Follow the implementation flow from XERXES.md:

1. Load `.xerxes/skills/run-research/SKILL.md`, then the domain skill that matches the surface (add-easydel-model /
