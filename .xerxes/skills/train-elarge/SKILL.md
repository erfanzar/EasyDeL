...
- Model or conversion trouble: load `.xerxes/skills/add-easydel-model/SKILL.md`
  or `.xerxes/skills/convert-checkpoint/SKILL.md`.
...
- Compile-time HBM OOM: load `.xerxes/skills/debug-training-oom/SKILL.md`.
- Serve mode or OpenAI-compatible output trouble: load
  `.xerxes/skills/debug-esurge/SKILL.md` and, for tool/reasoning outputs,
  `.xerxes/skills/tool-reasoning-parser/SKILL.md`.
