...
Load and follow `run-research` first. For disk pressure or staging failures, read `.xerxes/ops/OPS.md`.
...
If a dataset is meant for eLarge, also load `.xerxes/skills/train-elarge/SKILL.md`.
