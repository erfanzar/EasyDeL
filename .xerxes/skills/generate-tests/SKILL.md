...
Specialization of `.xerxes/skills/run-research/SKILL.md`. The quality bar and run environment come from
`.xerxes/skills/test-workspace/SKILL.md` — load it first.
