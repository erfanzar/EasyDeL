...
Specialization of `.xerxes/skills/run-research/SKILL.md`. For deep kernel tuning load
`.xerxes/skills/optimize-ejkernel-kernel/SKILL.md`; this skill produces honest A/B numbers for a change.
