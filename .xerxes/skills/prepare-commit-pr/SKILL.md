...
`.xerxes/skills/review-pr/SKILL.md`; for releases, load
`.xerxes/skills/release-workspace/SKILL.md`.
...
- Do not create or restore `XERXES.md` files for this repo unless the user reverses the current instruction.

## Checks

Run focused tests selected through `.xerxes/skills/test-workspace/SKILL.md` for the touched package. Also run:
...
`.xerxes/skills/release-workspace/SKILL.md` for the full release flow.
