...
class Qwen3MLP(spx.Module):
    ...
    def forward(
        ...
        gate: Float[Array, "batch seq_len intermediate_size"] = checkpoint_name(self.act_fn(gate_raw), "mlp_gate")
...
class Qwen3DecoderLayer(spx.Module):
    ...
    def forward(
        ...
        if self.config.use_scan_mlp:
            feed_forward_hidden_states: Float[Array, "batch seq_len hidden_dim"] = blockwise_ffn(
                self.mlp,
                feed_forward_input,
