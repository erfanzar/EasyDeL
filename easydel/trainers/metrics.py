...
class MetricsHistogram:
	...
	@staticmethod
	@jax.jit
	def _create_histogram_bin_edges(arr: jax.Array) -> tp.Tuple[jax.Array, jax.Array]:
	...
	def numpy_histogram(self) -> tp.Tuple[jax.Array, jax.Array]:
