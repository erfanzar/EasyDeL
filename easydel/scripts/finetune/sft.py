...
parser = ed.utils.DataClassArgumentParser((ed.SFTConfig, RunTimeConfig))
...
def main():
	...
	trainer = ed.SFTTrainer(
		...
		formatting_func=lambda x: processor.apply_chat_template(
			x[sft_config.dataset_text_field], tokenize=False
		),
	)
